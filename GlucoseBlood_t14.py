...
##
#
#   9. modositas a 2016_01_28_m3.txt inputhoz
#      input modositas
#            1. 882 sor "[g] 1   2   3 Megjegyz" tomoritese  "[g]123Megjegyz"
#            2. 1102 sor "Bólus   TBR" tomoritese "BólusTBR"   
#      program modositas 1,ures sorok modositasa
#                        2, vercukor ertekek tomoritese
#                        3, Bolus ertekek tomoritese
#                        4, Bazis ertekek tomoritese 
#
#
#
            ...
            if line == '':
                ...
                if len(a) == 1:
                    ...
                    if s3[0:14] == '[g]123Megjegyz' :
                        ...
                        print 'Vercukor ertekek beolvasasa'
                        while b2:
                        ...
                        print 'Vege a vercukor ertekek beolvasasanak'
                 ...
                 #   print s3
                    ...
                    if s3 ==  'Bólus'.decode('cp1250'):    
                      ...
                      # ures sorok atolvasasa  
                        ...
                        print 'Bolus ertekek beolvasasa'
                        while b3:                                   
                           # print line  ### 2016.0205
                           # print a     ###                 
                            if len(a) > 1:
                                if len(a) == 5:
                                  #  ertek1 = a[1]
                            ...
                            a = string.split(line)
                            if len(a) == 0:
                                print 'Vege a bolus beolvasasanak'
                            while len(a) == 0:
                                line = inFile.readline()
                                a = string.split(line)
...
def ex_iras(begin_dat,listak):
  ...
  ##  print lista_bazis  
    for m,e1 in enumerate (lista_bazis):
     ...
     ##   print e1[1]   # 2016_02
        cur_dat = e1[1][8:10] + e1[1][3:5] + e1[1][0:2]
     ##   print cur_dat
        ex = e1[3][0:4]
      ##  print str(m)  + ':   '+ str(e1[1]) + 'B:   ' + str(ex)
        if ex <> '0.00':
            if e1[1] == begin_dat:
                ## Hetfo
...
def main_bg():
  ...
  #  print Tab   ### 2016.02.04

    ido_end = Tab[0][0][1]
    print 'ido_end'
    print ido_end
    global end_date
    end_date = ido_end[6:10] + ido_end[2:6] + ido_end[0:2]
